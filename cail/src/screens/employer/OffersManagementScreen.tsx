...
const mockOffers: JobOffer[] = [
  {
    ...
    description: 'Responsable de crear y mantener servicios backend utilizando Node.js, Express y bases de datos SQL/NoSQL.',
    location: 'Loja',
    salary: '$1800 - $2500',
    modality: 'Remoto',
    priority: 'Alta',
    ...
    applications: 22,
    views: 58,
    requiredCompetencies: ['Node.js', 'API Rest', 'Bases de datos SQL/NoSQL'],
    requiredEducation: ['Ingeniería en Sistemas', 'Ingeniería en Ciencias de la Computación'],
    requiredExperience: '2-3 años en desarrollo backend',
  },
];
