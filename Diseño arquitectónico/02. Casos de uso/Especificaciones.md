...
| Nombre del Caso de Uso | Actores Principales | Resumen |
| :--- | :--- | :--- |
| **Gerente gestiona Empresa** | Gerente, Empresa | El gerente realiza la administración y configuración inicial de los datos de la empresa. |
| **Reclutador representa Empresa** | Reclutador, Empresa | Se vincula al reclutador como un representante autorizado de la empresa registrada. |
...
| Nombre del Caso de Uso | Actores Principales | Resumen |
| :--- | :--- | :--- |
| **RegistroCivil verifica Candidato** | Registro Civil, Sistema | El sistema conecta con Registro Civil para validar la identidad del candidato. |
| **Senecyt verifica Candidato** | Senescyt, Sistema | El sistema conecta con Senescyt para validar los títulos académicos del candidato. |
| **RegistroCivil valida Usuario** | Registro Civil | Validación general de identidad para usuarios nuevos. |
| **Senecyt valida Usuario** | Senescyt | Validación general de formación académica para usuarios. |
...
| Nombre del Caso de Uso | Actores Principales | Resumen |
| :--- | :--- | :--- |
| **Empresa registra Oferta** | Empresa, Usuario | La empresa inicia el borrador de una nueva vacante. |
| **Gerente aprueba Oferta** | Gerente | El gerente da el visto bueno a la oferta antes de ser visible. |
| **Reclutador publica Oferta** | Reclutador | El reclutador hace pública la oferta en la bolsa. |
| **Administrador genera Oferta** | Administrador | Caso especial donde el administrador crea una oferta directamente. |
...
| Nombre del Caso de Uso | Actores Principales | Resumen |
| :--- | :--- | :--- |
| **Reclutador actualiza Oferta** | Reclutador | Se actualizan datos, fechas o requisitos de una oferta activa. |
| **Reclutador modifica Oferta** | Reclutador | Modificación sustancial de la oferta o corrección de errores. |
...
### Diagrama 3.1, 3.2 y 3.3: Clasificación y Matching

**Descripción Técnica:**
Ilustra cómo el **Administrador** y la **Bolsa** analizan la base de datos, clasifican talento y ofertas, y generan recomendaciones automáticas.

* **Segmentación:** Se agrupa talento y ofertas por áreas, experiencia y ubicación.
* **Recomendación:** El sistema notifica nuevas oportunidades basadas en el perfil.

*(Imágenes de referencia de los diagramas de clasificación)*
...
| Nombre del Caso de Uso | Actores Principales | Resumen |
| :--- | :--- | :--- |
| **Matching analiza Candidato** | Sistema (Matching) | El algoritmo evalúa el perfil del candidato contra las vacantes. |
| **Matching busca Candidato** | Sistema (Matching) | Búsqueda inversa para encontrar candidatos idóneos para una oferta. |
| **Matching notifica Candidato** | Sistema (Matching) | Envío de alerta al candidato sobre una oferta compatible. |
| **Matching procesa Oferta** | Sistema (Matching) | Indexación de la oferta para ser encontrada por los candidatos. |
...
| Nombre del Caso de Uso | Actores Principales | Resumen |
| :--- | :--- | :--- |
| **Candidato postula Oferta** | Candidato | El usuario aplica formalmente a una vacante disponible. |
| **Postulacion asocia Candidato** | Sistema | Vínculo interno del ID del candidato al registro de postulación. |
| **Postulacion asocia Oferta** | Sistema | Vínculo interno del ID de la oferta al registro de postulación. |
| **Candidato consulta Oferta** | Candidato | El candidato revisa los detalles antes de postular. |
...
| Nombre del Caso de Uso | Actores Principales | Resumen |
| :--- | :--- | :--- |
| **Candidato revisa Postulacion** | Candidato | El candidato verifica el estado (enviado, visto, rechazado) de su aplicación. |
| **Candidato consulta Postulacion** | Candidato | Acceso al histórico y detalle de las postulaciones realizadas. |
...
| Nombre del Caso de Uso | Actores Principales | Resumen |
| :--- | :--- | :--- |
| **Reclutador selecciona Postulacion** | Reclutador | El reclutador abre una postulación específica para evaluarla. |
| **Reclutador selecciona Candidato** | Reclutador | Acción final donde se acepta al candidato para el puesto o siguiente fase. |
