...
main ─────────────────────────────────────────────────────►
       │
       ├── ErickGaona (Security & Testing) ───────────────►
       │
       ├── juan975 (Data Architecture) ───────────────────►
       │
       ├── cbhas-micro (Frontend Mobile) ─────────────────►
       │
       └── ALISrj (Backend) ──────────────────────────────►
```
...
|------|-----------|-------------|
| `main` | Código estable de producción | Juan Espinosa (merge) |
| `ErickGaona` | Seguridad, testing, documentación | Erick Gaona |
| `juan975` | Arquitectura de datos, matching | Juan Espinosa |
| `cbhas-micro` | Frontend móvil y web | Sebastián Calderón |
| `ALISrj` | Backend microservicios | Alex Ramírez |
